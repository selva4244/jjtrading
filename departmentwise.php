            ...
            <div class="row">
                <div class="col-md-12"><br><br>
                   <div class="irs-inner-heading">
                        <h2>DEPARTMENT WISE MOUS DETAILS</h2>
                        <i class="icofont icofont-education"></i>
                        <p><a href="index.php">HOME</a> > <a href="departmentwise.php">DEPARTMENT WISE MOUS DETAILS</a>
                        </p>
                    </div> 
                </div>
            </div>
            ...
            <div class="row">
                <!-- <div class="col-md-6 col-md-offset-3"> -->
                    ...
                    <div class="irs-section-title">
                        <h2 style="font-size:24px;"><span>DEPARTMENT WISE MOUS DETAILS</span></h2>
