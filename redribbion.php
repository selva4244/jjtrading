            ...
            <div class="row">
                <div class="col-md-12"><br><br>
                   <div class="irs-inner-heading">
                        ...
                        <p><a href="index.php">HOME</a> > <a href="redribbion.php">RED RIBBION</a>
                        </p>
                    </div> 
                </div>
            </div>
    ...
    <section class="irs-gallery-field">
        <div class="container">
            <div class="row">
                <!-- <div class="col-md-6 col-md-offset-3"> -->
                  ...
                  <h2 style="font-size:24px;"><span> RED RIBBIONDETAILS</span></h2>
        ...
        <img src="image/clg/red.jpg" align="center" style="width:100%;">
